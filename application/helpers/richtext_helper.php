...
if ( ! function_exists('generate_rich_box'))
{
	function generate_rich_box($title = '')
	{
		...
		echo '<div class="hero-unit">
			...
			<div id="editor" class="lead" placeholder=""></div>
		</div>';
	}
}

if ( ! function_exists('generate_rich_box2'))
{
	function generate_rich_box2($title = '',$cont)
	{
		echo "<h2>". $title ."</h2>";
		...
		echo '<div class="hero-unit">
			...
			<div id="editor" class="lead" placeholder="">' .$cont. '</div>
		</div>';
	}
}
...
if ( ! function_exists('sources'))
{
	...
	<script src='http://netdna.bootstrapcdn.com/bootstrap/3.0.3js/bootstrap.min.js'></script>";
		}
		$styles .= "
	<link
